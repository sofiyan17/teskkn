...
<html lang="en">
    <head>
        ...
        <title>Data Pindah - SB Admin</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Form Data Pindah</h1>
                ...
                <!-- form -->
                <form action="add_data_pindah.php" method="POST">
                    <div class="container">
                        <div class="container border rounded px-3 py-3">
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama</label>
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Yang Pindah" required>
                            </div>

                            <div class="mb-3">
                                <label for="nik" class="form-label">NIK</label>
                                <input type="text" class="form-control" name="nik" id="nik" placeholder="NIK Yang Pindah" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="dusun_tujuan" id="dusun-tujuan" placeholder="Dusun Tujuan" required>
                            </div>
                    
                            <div class="mb-3">
                                <label for="desa-tujuan" class="form-label">Desa Tujuan</label>
                                <input type="text" class="form-control" name="desa_tujuan" id="desa-tujuan" placeholder="Desa Tujuan" required>
                            </div>
                    
                            <div class="mb-3">
                                <label for="kecamatan-tujuan" class="form-label">Kecamatan Tujuan</label>
                                <input type="text" class="form-control" name="kecamatan_tujuan" id="kecamatan-tujuan" placeholder="Kecamatan Tujuan" required>
                            </div>
                    
                            <div class="mb-3">
                                <label for="kabupaten-tujuan" class="form-label">Kabupaten Tujuan</label>
                                <input type="text" class="form-control" name="kabupaten_tujuan" id="kabupaten-tujuan" placeholder="Kabupaten Tujuan" required>
                            </div>
